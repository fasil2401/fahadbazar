        ...
        child: Padding(
          ...
          child: ListView(
            ...
            children: [
              ...
              commonHeight2,
             const InformationTile(title: 'Order History', url: 'assets/icons/account/order_history.svg',),
             commonHeight2,
             const InformationTile(title: 'Address book', url: 'assets/icons/account/address_book.svg',),
             commonHeight2,
             const InformationTile(title: 'Edit profile', url: 'assets/icons/account/edit.svg',),
             commonHeight2,
             const InformationTile(title: 'Notifications', url: 'assets/icons/account/notification.svg',),
             commonHeight2,
              Text(
                'Others',
                style: TextStyle(
              ...
              commonHeight2,
             const InformationTile(title: 'Support', url: 'assets/icons/account/support.svg',),
             commonHeight2,
             const InformationTile(title: 'Share the app', url: 'assets/icons/account/share.svg',),
             commonHeight2,
             const InformationTile(title: 'About us', url: 'assets/icons/account/about.svg',),
             commonHeight2,
