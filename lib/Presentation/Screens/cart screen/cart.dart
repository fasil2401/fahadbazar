      ...
      body: Padding(
        ...
        child: ListView(
          ...
          children: [
            ...
            Container(
              decoration:
                  BoxDecoration(color: Colors.white, borderRadius: cartRadius),
              child: Padding(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        CartNameText(
                            sw: sw,
                            text: 'Would yu like to pay cash on delivery'),
                        Radio<Payment>(
                          fillColor: MaterialStateColor.resolveWith(
                              (states) => textBlueColor),
                          focusColor: MaterialStateColor.resolveWith(
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: AddressDetails(type: 'Home',),
                        ),
                        Radio<Address>(
                          fillColor: MaterialStateColor.resolveWith(
                              (states) => textBlueColor),
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: AddressDetails(type: 'Office',),
                        ),
                        Radio<Address>(
                          fillColor: MaterialStateColor.resolveWith(
                              (states) => textBlueColor),
